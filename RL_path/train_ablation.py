...
def user_model_train(course, device, BATCH_SIZE,emb_dim):
    ...
    model = path_env(input_size=emb_dim, hidden_size=emb_dim, num_layers=3, n_users=310, emb_size=emb_dim, item_emb_path=item_emb_path, device=device)
    # n_items 代表序列最长长度
    model.to(device)
...
print(c_name, ": precsion: ", avg_p/5," recall: ",avg_r/5," f1 score: ",avg_f/5)
# file = open(c_name+'_result_to10_5.txt','a')
